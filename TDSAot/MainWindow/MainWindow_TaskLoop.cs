    ...
    public partial class MainWindow : Window
    {
        ...
        private async void SearchFilesThreadLoop(CancellationToken cancellationToken)
        {
            ...
            while (runningState.Threadrunning == true && !cancellationToken.IsCancellationRequested)
            {
                ...
                runningState.Threadrest = false;  //������ǩ

                string threadKeyword = keyword;
                if (string.IsNullOrEmpty(threadKeyword)) continue;  //���˵�һ�δ���ʱ��ˢ��
                ...
                try
                {
                    ...
                    {
                        if (runningState.Threadrest) { return; } //��ֹ��ǩ
                        ...
                        {
                            if (runningState.Threadrest) { break; } //��ֹ��ǩ
                            ...
                            if (finded)
                            {
                                ...
                                if (resultNum < 50)//��ǰ��ʾ
                                {
                                    ...
                                    UpdateList(false);  //�����첽BeginInvoke����Ȼ��ͬ��
                                }
                            }
                        }
                    });
                ...
                if (!runningState.Threadrest)
                {
                    ...
                    {
                        resultNumGlobal = resultNum;
                        UpdateList();  //�����첽BeginInvoke����Ȼ��ͬ��
                    }
                    else
                    {
                        resultNumGlobal = resultNum;
                        UpdateList();  //�첽BeginInvoke
                    }
                }
Restart:;
            }
